                 ...
                 <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="ml-auto d-flex align-items-center" as="ul">
                      ...
                      <NavDropdown className="mx-3 text-center" title="Разделы" as="ul" id="basic-nav-dropdown">
                        <NavDropdown.Item as="li" ><Link to="/science">наука</Link></NavDropdown.Item>
                        <NavDropdown.Item as="li" ><Link to="/news">новости</Link></NavDropdown.Item>
                        <NavDropdown.Item as="li" ><Link to="/sport">спорт</Link></NavDropdown.Item>
                      </NavDropdown>
